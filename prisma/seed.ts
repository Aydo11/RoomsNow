  ...
  const [free, professional, business, referrerFree, referrerPro] = await Promise.all([
    ...
    db.membership.create({
      data: {
        ...
        description: "For growing providers managing up to 40 properties and rooms.",
      },
    }),
    db.membership.create({
      data: {
        ...
        description: "For larger portfolios managing up to 90 properties and rooms, with priority placement and support.",
      },
    }),
    db.membership.create({
      data: {
